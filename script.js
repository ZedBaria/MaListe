function showSpoiler(id)
    ...
    if(id == 'Description')
    { 
        boite.innerHTML="Ayant obtenu mon BTS SNIR et étant inscrit à l'école EPSI la défense, je suis en recherche d'alternance en tant que développeur WEB. <br><br>Je me présente Mehdi PICHARD, agé de 20 ans, j'ai commencé à être passionné par l'informatique grâce à mon père et l'Arduino et depuis je m'intéresse à tout ce qui tourne autour de l'informatique.<br><br> J'ai réalisé différents projets en Arduino tous très passionnant.<br> Je suis intéressé dans le travail d'équipe, et j'adore travailler en groupe afin de mettre en commun nos idées";
    }
    if(id == 'Formations')
    {
        boite.innerHTML="<span class='gras'>Etudiant en Bachelor 3ème année</span><br>Octobre 2020<br>Entrée à l'école EPSI<br><br><span class='gras'>Formation en programmation WEB</span><br>Suivie sur le site Udemy proposant différents enseignements.<br>Telle que la programmation WEB :HTML/CSS/PHP/SQL/JAVASCRIPT<br><br><span class='gras'>Etudiant en BTS SNIR</span><br>Septembre 2018/Juillet 2020<br><br><span class='gras'>Baccalauréat STI2D AC</span><br>Juin 2018";
    }
    if(id == 'Expériences')
    {
    ...
    if(id == 'Projets')
    {
        boite.innerHTML="Réalisation d’un site Web dédié à STAR WARS(HTML,CSS,PHP).<br><br>Réalisation d’une sonnette de porte, avec matériel Arduino grâce à une connexion radio.<br><br>Réalisation d’un module permettant la manipulation d’un Robot (Hercule 2000) à l’aide d’un joystick codé en Java.";
    }
    if(id == 'Contact')
    {
